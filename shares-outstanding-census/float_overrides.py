...
OVERRIDES = {
    ...
    "0001314152-25-000031": {'rows': [{'cover': '1173740000', 'xbrl': '', 'as_of': '2024-06-28', 'label': 'Class A Common Stock', 'flags': 'SCALE_THOUSANDS_CORRECTED'}, {'cover': '306657000', 'xbrl': '', 'as_of': '2024-06-28', 'label': 'Class M Common Stock', 'flags': 'SCALE_THOUSANDS_CORRECTED'}, {'cover': '38068000', 'xbrl': '', 'as_of': '2024-06-28', 'label': 'Class A-I Common Stock', 'flags': 'SCALE_THOUSANDS_CORRECTED'}, {'cover': '1055952000', 'xbrl': '', 'as_of': '2024-06-28', 'label': 'Class M-I Common Stock', 'flags': 'SCALE_THOUSANDS_CORRECTED'}, {'cover': '28168000', 'xbrl': '', 'as_of': '2024-06-28', 'label': 'Class D Common Stock', 'flags': 'SCALE_THOUSANDS_CORRECTED'}], 'provenance': "JLL Income Property Trust (non-traded REIT, NAV-based float, no XBRL tag). Date fix (cover's 2024-06-28 over the XBRL 2024-06-30) PLUS a thousands scale correction caught by the 2026-07-02 combined-dataset audit: the cover reads 'the aggregate market value of the 100,257,024 shares of Class A common stock ... held by non-affiliates was $1,173,740 ... based upon the last net asset value of $11.71 ... per share'; 100,257,024 x $11.71 = $1.174B, so the printed $1,173,740 is in thousands and the extractor recorded the mantissa at scale 0 (1000x too small). Corrected x1000 for all five classes (A/M/A-I/M-I/D); the NAV cross-check holds independently for each (ratio ~1.000). True total float ~$2.603B. [date fix retained; scale corrected]"},
    "0001023458-25-000009": {'rows': [{'cover': '11749372', 'xbrl': '', 'as_of': '2024-12-31', 'label': 'Units of limited partnership interest', 'flags': 'PROSE_FLOAT_XBRL_TAGGED_ZERO'}], 'provenance': "AEI Income & Growth Fund XXII LP. The cover states the non-affiliate float: 'Units of limited partnership interest outstanding and owned by nonaffiliates of the registrant, which Units had an aggregate market value (based solely on the price at which they were sold since there is no ready market for such Units) of $11,749,372.' The filer XBRL-tagged EntityPublicFloat=0, so the census recorded ZERO_FACT -> TAGGED_ZERO_COVER_SILENT and missed the prose value; caught by the 2026-07-02 TAGGED_ZERO cover sweep. Float = $11,749,372 as of the tag instant 2024-12-31."},
    "0001023458-25-000011": {'rows': [{'cover': '36986364', 'xbrl': '', 'as_of': '2024-12-31', 'label': 'Units of limited membership interest', 'flags': 'PROSE_FLOAT_XBRL_TAGGED_ZERO'}], 'provenance': "AEI Income & Growth Fund 25 LLC. The cover states the non-affiliate float: 'Units of limited membership interest outstanding and owned by nonaffiliates of the registrant, which Units had an aggregate market value (based solely on the price at which they were sold since there is no ready market for such Units) of $36,986,364.' The filer XBRL-tagged EntityPublicFloat=0 (ZERO_FACT), so the census missed the prose value; caught by the 2026-07-02 sweep. Float = $36,986,364 as of the tag instant 2024-12-31."},
